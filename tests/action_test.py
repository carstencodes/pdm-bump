...
class ActionTest(unittest.TestCase):
    CREATE_NEXT_VERSION_PARAMS: list[
        ...
        (
            ...
            "1.0.0",
            "2.0.0",
            lambda v: MajorIncrementingVersionModifier(v, True),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "2.0.0",
            lambda v: MajorIncrementingVersionModifier(v, False),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.1.0",
            lambda v: MinorIncrementingVersionModifier(v, True),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.1.0",
            lambda v: MinorIncrementingVersionModifier(v, False),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.1",
            lambda v: MicroIncrementingVersionModifier(v, True),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.1",
            lambda v: MicroIncrementingVersionModifier(v, False),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.0a1",
            lambda v: AlphaIncrementingVersionModifier(v, False),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.1a1",
            lambda v: AlphaIncrementingVersionModifier(v, True),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.0b1",
            lambda v: BetaIncrementingVersionModifier(v, False),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.1b1",
            lambda v: BetaIncrementingVersionModifier(v, True),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.0rc1",
            lambda v: ReleaseCandidateIncrementingVersionModifier(v, False),
        ),
        (
        ...
        (
            ...
            "1.0.0",
            "1.0.1rc1",
            lambda v: ReleaseCandidateIncrementingVersionModifier(v, True),
        ),
        (
        ...
        (
            ...
            "1.2.3",
            "1!1.2.3",
            lambda v: EpochIncrementingVersionModifier(v, False, False),
        ),
        (
            "Increment epoch without an epoch and without resetting version or removing any version part",
            "1.2.3a4",
        ...
        (
            ...
            "1.2.3",
            "1!1.2.3",
            lambda v: EpochIncrementingVersionModifier(v, True, False),
        ),
        (
            "Increment epoch without an epoch and without resetting version or removing any version part",
            "1.2.3a4",
        ...
        (
            ...
            "1.2.3",
            "1!1.0.0",
            lambda v: EpochIncrementingVersionModifier(v, False, True),
        ),
        (
            "Increment epoch without an epoch and without resetting version or removing any version part",
            "1.2.3a4",
        ...
        (
            ...
            "1.2.3",
            "1!1.0.0",
            lambda v: EpochIncrementingVersionModifier(v, True, True),
        ),
        (
            "Increment epoch without an epoch and without resetting version or removing any version part",
            "1.2.3a4",
        ...
        (
            ...
            "1.2.3",
            "1.2.3",
            lambda v: FinalizingVersionModifier(v),
        ),
        (
            "Remove non-final parts",
            "1.2.3a1",
